  ...
  return (
    <form onSubmit={handleSubmit(handleFormSubmit)} noValidate className="space-y-6 max-w-2xl">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label htmlFor="poster_url" className="block text-xs font-medium text-white/50 mb-1.5 uppercase tracking-wider">Poster URL</label>
          <input
            id="poster_url"
            {...register('poster_url')}
            placeholder="https://..."
        ...
        <div>
          <label htmlFor="backdrop_url" className="block text-xs font-medium text-white/50 mb-1.5 uppercase tracking-wider">Backdrop URL</label>
          <input
            id="backdrop_url"
